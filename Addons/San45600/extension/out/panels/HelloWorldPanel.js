    ...
    _getWebviewContent(webview, extensionUri) {
      ...
      <html lang="en">
        <head>
          ...
          <meta http-equiv="Content-Security-Policy" content="default-src 'none'; media-src https:; img-src https:; script-src ${webview.cspSource} https: blob: 'unsafe-eval'; connect-src https: blob:; style-src ${webview.cspSource} https:; font-src https:;" />
